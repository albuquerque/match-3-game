...
func _resolve_theme_name() -> String:
	# theme manager lookup via NodeResolvers autoload
...
func _on_mouse_entered():
	...
	if not is_falling and not GameRunState.processing_moves and sprite and sprite.texture:
...
func handle_click():
	...
	if is_falling or GameRunState.processing_moves:
		print("Click blocked - falling: ", is_falling, " processing: ", GameRunState.processing_moves)
		return
